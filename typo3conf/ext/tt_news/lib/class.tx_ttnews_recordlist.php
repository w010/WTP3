...
//				</span>';
	...
	function getIcon($table,$row,$noEdit)	{
		...
		//$iconImg = \TYPO3\CMS\Backend\Utility\IconUtility::getIconImage($table,$row,$this->backPath,'title="'.$alttext.'"');
		//$iconImg = \TYPO3\CMS\Backend\Utility\IconUtility::getSpriteIcon($table,$row,$this->backPath,'title="'.$alttext.'"');
		// wolo 7 mod
