<?php
namespace thinkopen_at\KbTvContSlide;
...
***************************************************************/
/**
 * Controller for the 'kb_tv_cont_slide' extension.
 *
 * $Id$
 *
...
class SlideController extends \TYPO3\CMS\Frontend\Plugin\AbstractPlugin {
	...
	protected function getPageFlexValue($page, $field) {
		$xml = GeneralUtility::xml2array($page['tx_templavoila_flex']);
		$ds = BackendUtility::getFlexFormDS($GLOBALS['TCA']['pages']['columns']['tx_templavoila_flex']['config'], $page, 'pages', 'tx_templavoila_flex');
